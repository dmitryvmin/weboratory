...
// Utils
import { setToPath } from "@utils/date/setToPath";
...
import { getTimePeriodIdx } from "@utils/date/getTimePeriodIdx";
import { getChildTimePeriod } from "@utils/date/getChildTimePeriod";
import { getIntervalsForSegment } from "@utils/date/getIntervalsForSegment";
import { getSegmentIdxFromDate } from "@utils/date/getSegmentIdxFromDate";
...
import {
  ...
  FillIntervalProps, FillTimeTableProps, FillWholeProps,
  GetTimeTableDatesProps, GetTimeTableMapsProps,
  TimeTableDatesType,
  TimeTableIntervalCollectionType, TimeTableIntervalType, TimeTableMapsType, TimeTableType,
} from "@stores/globalStore/stores/timetable/types";
