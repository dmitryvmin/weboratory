...
import { getFromPath } from "@utils/date/getFromPath";

// Test Utils
import { timePeriodTestCases } from "@stores/globalStore/stores/slider/__mocks__/timePeriodTestCases";
...
describe("TimeTable class test", () => {
  ...
  for (let i = 0; i < timePeriodTestCases.length; i++) {
    ...
    it(`should generate a timeTable data structure for the ${timePeriod} timePeriod.`, () => {
      ...
      // given
      const timeTable = TimeTableUtils.createTimeTable({
